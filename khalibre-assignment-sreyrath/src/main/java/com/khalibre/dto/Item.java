...
public class Item {
	...
	public String toString() {
		return "Item [id=" + id + ", name=" + name + ", full_name=" + full_name + ", html_url=" + html_url
				+ ", description=" + description + ", fork=" + fork + ", url=" + url + ", forks_url=" + forks_url
				+ ", keys_url=" + keys_url + ", collaborators_url=" + collaborators_url + ", teams_url=" + teams_url
				+ ", hooks_url=" + hooks_url + ", issue_events_url=" + issue_events_url + ", events_url=" + events_url
				...
				+ issue_comment_url + ", contents_url=" + contents_url + ", compare_url=" + compare_url + ", merges_url="
				+ merges_url + ", archive_url=" + archive_url + ", downloads_url=" + downloads_url + ", issues_url="
				+ issues_url + ", pulls_url=" + pulls_url + ", milestones_url=" + milestones_url
				...
				+ language + ", has_issues=" + has_issues + ", has_downloads=" + has_downloads + ", has_wiki="
				+ has_wiki + ", has_pages=" + has_pages + ", forks_count=" + forks_count + ", mirror_url=" + mirror_url
				+ ", open_issues_count=" + open_issues_count + ", forks=" + forks + ", open_issues=" + open_issues
				+ ", watchers=" + watchers + ", default_branch=" + default_branch + ", score=" + score + "]";
	}
